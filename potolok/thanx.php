...
<body>
    ...
    <div class="contacts header container">
        <a class="contacts__measure">Вызвать замерщика <b>бесплатно</b></a>
        <!-- <a class="contacts__phone" href="tel:88005119715">8 800 511-97-15</a> -->
    </div>
    <section class="main thx container">
            <h1><b class="c-blue">СПАСИБО!</b></h1>
            <p class="text">Ваша заявка принята </p>
            <p class="main__consult">Хочу консультацию!</p>
